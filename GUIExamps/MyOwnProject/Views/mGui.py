...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade aa26ff80e55e on Tue Mar 14 07:06:22 2017
#
...
class MyFrame1(wx.Frame):
    ...
    def menu_keluar(self, event):  # wxGlade: MyFrame1.<event_handler>
        print("Event handler 'menu_keluar' not implemented!")
        event.Skip()

    def menu_layar1(self, event):  # wxGlade: MyFrame1.<event_handler>
        print("Event handler 'menu_layar1' not implemented!")
        import layar1
        layar1.__init__()
        event.Skip()

    def menu_layar2(self, event):  # wxGlade: MyFrame1.<event_handler>
        print("Event handler 'menu_layar2' not implemented!")
        event.Skip()

    def menu_pengembang(self, event):  # wxGlade: MyFrame1.<event_handler>
        print("Event handler 'menu_pengembang' not implemented!")
        event.Skip()

    def menu_bantuan(self, event):  # wxGlade: MyFrame1.<event_handler>
        print("Event handler 'menu_bantuan' not implemented!")
        event.Skip()

    def Yes(self, event):  # wxGlade: MyFrame1.<event_handler>
