...
class RangkaInti(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: RangkaInti.__init__
        ...
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_ANY, "Keluar", "")
        self.Bind(wx.EVT_MENU, self.keluar_jendela, id=wxglade_tmp_item.GetId())
        wxglade_tmp_menu.Append(wx.ID_ANY, "item", "")
        self.Menu.Append(wxglade_tmp_menu, "Berkas")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, "item", "")
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_ANY, "Printer", "")
        self.Bind(wx.EVT_MENU, self.buka_printer, id=wxglade_tmp_item.GetId())
        self.Menu.Append(wxglade_tmp_menu, "Pengaturan")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, "item", "")
        self.Menu.Append(wxglade_tmp_menu, "Laporan")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_ANY, "Pengembang", "")
        self.Bind(wx.EVT_MENU, self.buka_pengembang, id=wxglade_tmp_item.GetId())
        self.Menu.Append(wxglade_tmp_menu, "Informasi")
    ...
    def __set_properties(self):
        # begin wxGlade: RangkaInti.__set_properties
        self.SetTitle("frame")
        self.SetFont(wx.Font(11, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, "Noto Sans"))
    ...
    def __do_layout(self):
        # begin wxGlade: RangkaInti.__do_layout
    ...
    def keluar_jendela(self, event):  # wxGlade: RangkaInti.<event_handler>
        print("Event handler 'keluar_jendela' not implemented!")
        event.Skip()

    def Input(self, event):  # wxGlade: RangkaInti.<event_handler>
        print("Event handler 'Input' not implemented!")
        event.Skip()

    def pilihan_lainnya(self, event):  # wxGlade: RangkaInti.<event_handler>
        print("Event handler 'pilihan_lainnya' not implemented!")
        event.Skip()

    def buka_printer(self, event):  # wxGlade: RangkaInti.<event_handler>
        print("Event handler 'buka_printer' not implemented!")
        event.Skip()
    def buka_pengembang(self, event):  # wxGlade: RangkaInti.<event_handler>
        print("Event handler 'buka_pengembang' not implemented!")
        event.Skip()
# end of class RangkaInti
