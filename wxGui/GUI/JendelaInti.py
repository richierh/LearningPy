...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 9a4613e7dab8 on Mon Apr 24 16:21:14 2017
#
...
class JendelaInti(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.list_ctrl_4.SetMinSize((800, 435))
    ...
    def __do_layout(self):
        ...
        self.sizer_1.Add(self.list_ctrl_4, 1, 0, 0)
        self.panel_1.SetSizer(self.sizer_1)
        sizer_14.Add(self.panel_1, 5, wx.EXPAND, 0)
        ...
        sizer_14.Add(grid_sizer_6, 0, wx.LEFT | wx.RIGHT, 10)
