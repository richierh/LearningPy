...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 9a4613e7dab8 on Tue Apr 18 18:09:08 2017
#
...
class JendelaInti(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.bitmap_1 = wx.StaticBitmap(self.Menu_Utama, wx.ID_ANY, wx.Bitmap("/home/pmc/mygit/LearningPy/wxGui/GUI/images.png", wx.BITMAP_TYPE_ANY))
        ...
        self.text_ctrl_2 = wx.TextCtrl(self.Penjualan, wx.ID_ANY, _("1"), style=wx.TE_CENTRE)
        ...
        self.button_3 = wx.Button(self.Penjualan, wx.ID_ANY, _("Cetak & Simpan"))
        self.button_1 = wx.Button(self.Penjualan, wx.ID_ANY, _("Cetak Saja"))
        self.button_4 = wx.Button(self.Penjualan, wx.ID_ANY, _("Hapus"))
        self.button_5 = wx.Button(self.Penjualan, wx.ID_ANY, _("Lihat"))
        self.button_6 = wx.Button(self.Penjualan, wx.ID_ANY, _("Pilihan Lainnya"), style=wx.BU_EXACTFIT)
    ...
    def __set_properties(self):
        ...
        self.grid_1.SetColLabelValue(3, _(" HARGA\n SATUAN"))
        self.grid_1.SetColSize(3, 100)
        self.grid_1.SetColLabelValue(4, _("KETERANGAN"))
    ...
    def __do_layout(self):
        ...
        label_2 = wx.StaticText(self, wx.ID_ANY, _("APLIKASI PENJUALAN KASIR CANGGIH"))
        label_2.SetFont(wx.Font(15, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        sizer_3.Add(label_2, 0, wx.ALIGN_CENTER, 0)
        sizer_1.Add(self.bitmap_1, 2, wx.EXPAND, 0)
        self.Menu_Utama.SetSizer(sizer_1)
        sizer_6.Add((0, 0), 0, 0, 0)
        label_5 = wx.StaticText(self.panel_3, wx.ID_ANY, _("0"), style=wx.ALIGN_CENTER | wx.ALIGN_RIGHT)
        ...
        label_1 = wx.StaticText(self.Penjualan, wx.ID_ANY, _("Kode Barang"))
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER | wx.LEFT, 8)
        grid_sizer_1.Add(self.text_ctrl_1, 0, wx.LEFT | wx.RIGHT, 8)
        label_3 = wx.StaticText(self.Penjualan, wx.ID_ANY, _("Jumlah"))
        ...
        self.notebook_1.AddPage(self.Menu_Utama, _("Menu Utama"))
        self.notebook_1.AddPage(self.Penjualan, _("Penjualan"))
        self.notebook_1.AddPage(self.Data_Barang, _("Data Barang"))
        self.notebook_1.AddPage(self.Data_Pekerja, _("Data Pekerja"))
        self.notebook_1.AddPage(self.Pengaturan, _("Pengaturan"))
